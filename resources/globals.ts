...
export const abilityMap = {
  ...
  6: { icon: "/icons/SGE/panhaima.png", color1: "#60cdb2", color2: "#08453f" },
  7: { icon: "/icons/SGE/haima.png", color1: "#60cdb2", color2: "#08453f" },
  8: { icon: "/icons/SGE/physis_II.png", color1: "#60cdb2", color2: "#08453f" },
  9: {
