...
export async function POST() {
  try {
    // add encounter
    await prisma.$executeRaw`INSERT INTO "Encounter" (name, level, duration) VALUES ('Eden''s Gate: Refulgence',  80, 838);
...
`;
    ...
    // add jobs
    await prisma.$executeRaw`INSERT INTO "Job" (name, role) VALUES ('Sage', 'HEALER'), ('Astrologian', 'HEALER'), ('Scholar', 'HEALER'), ('White Mage', 'HEALER')
`;
