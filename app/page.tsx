    ...
    <main className={css.homeContainer}>
      ...
      <div className={css.subcontainer}>
        ...
        <Link href={"/encounters/1/"} className={css.link}>
          <h3>Dancing Green</h3>
          <Image src={"/encounters/m5s.png"} alt="" width={376} height={120} />
        </Link>
        <Link href={"/encounters/2/"} className={css.link}>
          <h3>Sugar Riot</h3>
          <Image src={"/encounters/m6s.png"} alt="" width={376} height={120} />
        </Link>
        <Link href={"/encounters/3/"} className={css.link}>
          <h3>Brute Abombinator</h3>
          <Image src={"/encounters/m7s.png"} alt="" width={376} height={120} />
        </Link>
        <Link href={"/encounters/4/"} className={css.link}>
          <h3>Howling Blade</h3>
          <Image src={"/encounters/m8s.png"} alt="" width={376} height={120} />
        </Link>
      </div>
    </main>
  );
